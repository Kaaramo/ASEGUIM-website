...
/** Formulaire de partenariat ASEGUIM (démo). */
  ...
  return (
    ...
    >
      <label className="block">
        ...
        <input name="entreprise" placeholder="Le nom de votre entreprise" className="input-careloop" />
      </label>
      ...
      <Pill href="#" variant="orange" size="lg" arrow className="mt-6 w-full">
        {sent ? "Demande reçue, merci !" : "Soumettre ma demande de partenariat"}
      </Pill>
